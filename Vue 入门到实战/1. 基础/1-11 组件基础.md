...
![1542246181272](E:\笔记\Vue 入门到实战\1. 基础\1-11 组件基础.assets\1542246181272.png)
...
![1542246200573](E:\笔记\Vue 入门到实战\1. 基础\1-11 组件基础.assets\1542246200573.png)
...
当点击这个按钮时，我们需要告诉父级组件放大所有博文的文本。幸好 Vue 实例提供了一个自定义事件的系统来解决这个问题。我们可以调用内建的 [**$emit** 方法](https://cn.vuejs.org/v2/api/#vm-emit)并传入事件的名字，来向父级组件触发一个事件：
...
![1542247856866](E:\笔记\Vue 入门到实战\1. 基础\1-11 组件基础.assets\1542247856866.png)
...
![1542247925607](E:\笔记\Vue 入门到实战\1. 基础\1-11 组件基础.assets\1542247925607.png)
